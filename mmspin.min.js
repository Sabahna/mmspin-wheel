        ...
        switch (step) {
            ...
            case 2:
                ...
                $('#previous').click(function () {
                    ...
                    clearInput();
                    $(mmspinMobileInput).removeAttr('disabled');
                    $(mmspinFullnameInput).removeAttr('disabled');
                    $(citySelect).removeAttr('disabled');
                    $(townshipSelect).removeAttr('disabled');
                    stepper(1);
                });
    ...
    $(async function () {
        $.ajax({
            ...
            success: function (response) {
                if (response[0].banner_status) {
                    createImage(
                        response[0].banner_image,
                        response[0].mobile_banner_image
                    );
                }
